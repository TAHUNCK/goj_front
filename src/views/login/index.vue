  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <router-link to="/register/index">
        <el-button type="primary" style="width:50%;border-radius: 4px 0 0 4px;">Register</el-button>
      </router-link>
      <router-link to="/findPassword">
        <el-button type="warning" style="width:50%;border-radius: 0 4px 4px 0;">Find Back The Password?</el-button>
      </router-link>
    </el-form>
  </div>
</template>
